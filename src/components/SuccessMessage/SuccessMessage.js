...
const SuccessIcon = inject('app')(
  observer(({ app }: SuccessIconProps) => {
    return (
      <SuccessSvg
        x="0px"
        y="0px"
        ...
        <g>
          <g id="venture-risk-climb-mountain-success_1_">
            <path
              ...
              d="M61,30V9V1c0-0.332-0.165-0.642-0.439-0.828c-0.275-0.186-0.624-0.224-0.932-0.101l-10,4C49.249,4.224,49,4.591,49,5
            ...
            <path
              className="success-path"
              d="M1.726,43.687c2.424-2.562,7.46-0.953,10.469,0.007c1.247,0.398,2.446,0.597,3.579,0.597c1.153,0,2.229-0.228,3.226-0.636
...
const SuccessMessage = ({ message }: Props) => {
  return (
    <Flex column justify="center" align="center">
      <SuccessIcon />
      <StyledText size="large">{message}</StyledText>
    </Flex>
  );
};
